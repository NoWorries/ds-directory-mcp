...
def run_dry_check(name: str, start_url: str, max_pages: int = DRY_RUN_MAX_PAGES) -> str:
    ...
    (
        pages, all_links, _page_titles, _hit_max_pages, _start_url_error,
        _unchanged, _freshness, _fetched_count, _has_localized_docs, _newly_dead,
    ) = crawl([start_url], max_pages=max_pages)
